"""
Harriman Park Three Reservoirs Video Configuration
Configuration for the Harriman Park Three Reservoirs video project.
"""

# Input/Output Paths
INPUT_FOLDER = r"assets\input\0803"  # Path to input images/videos
OUTPUT_FILE = r"assets\output\ThreeReservoirs_20250803.mp4"  # Output video filename
MUSIC_FILE = r"assets\music\red-river-valley-296148.mp3"  # Background music file

# Video Content
TITLE = "Harriman Park Three Reservoirs"  # Main title
SUBTITLE = "August 3, 2025"  # Subtitle
